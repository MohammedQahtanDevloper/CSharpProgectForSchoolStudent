...
namespace Qusai.Form_school
{
    public partial class Classroom : Form
    {
        ...
        {
            InitializeComponent();
            da = new SqlDataAdapter("SELECT Classroom_id AS'معرف الصف الدراسي' , Classroom_name AS'اسم الصف الدراسي' FROM TB_classroom", SqlConnection);
            da.Fill(dt);
            dgList.DataSource = dt;
            textid.DataBindings.Add("text", dt, "معرف الصف الدراسي");
            textname.DataBindings.Add("text", dt, "اسم الصف الدراسي");
